...
def plot_curve():
    ...
    training_sizes, training_scores, testing_scores = learning_curve(
        reg, X, y, cv=cv, scoring=score)

    # TODO: Plot the training curves and the testing curves
    #       Use plt.plot twice -- one for each score. Be sure to give them labels!
    plt.plot(training_sizes, training_scores, color="r", label="training score")
    plt.plot(training_sizes, testing_scores, color="g", label="cross-validation score")
